  ...
  charArr.forEach(function(textChar, i, charArr){
    ...
    if(charConvertObj[char] !== undefined){
      if (count === 1) {
        ...
        switch (char) {
          case 'T':
            if (charArr[i+1] === 'S' || charArr[i+1] === 's') { char = 'TS'; count = 1; }
            break;
          case 't':
            if (charArr[i+1] === 'S' || charArr[i+1] === 's') { char = 'ts'; count = 1; }
            break;
          case 'O':
            if (charArr[i+1] === '\'') { char = 'O\''; count = 1; }
            break;
          case 'o':
            if (charArr[i+1] === '\'') { char = 'o\''; count = 1; }
            break;
          case 'G':
            if (charArr[i+1] === '\'') { char = 'G\''; count = 1; }
            break;
          case 'g':
            if (charArr[i+1] === '\'') { char = 'g\''; count = 1; }
            break;
          case 'Y':
            if (charArr[i+1] === 'a' || charArr[i+1] === 'A') { char = 'Ya'; count = 1; } 
            else if (charArr[i+1] === 'o' || charArr[i+1] === 'O') { char = 'Yo'; count = 1; } 
            else if (charArr[i+1] === 'u' || charArr[i+1] === 'U') { char = 'Yu'; count = 1; } 
            else if (charArr[i+1] === 'e' || charArr[i+1] === 'E') { char = 'Ye'; count = 1; }
            break;
          case 'y':
            if (charArr[i+1] === 'a' || charArr[i+1] === 'A') { char = 'ya'; count = 1; } 
            else if (charArr[i+1] === 'o' || charArr[i+1] === 'O') { char = 'yo'; count = 1; } 
            ...
            break;
          case 'S':
            if (charArr[i+1] === 'h' || charArr[i+1] === 'H') { char = 'Sh'; count = 1; }
            break;
          case 's':
            if (charArr[i+1] === 'h' || charArr[i+1] === 'H') { char = 'sh'; count = 1; }
            break;
          case 'C':
            if (charArr[i+1] === 'h' || charArr[i+1] === 'H') { char = 'Ch'; count = 1; }
            break;
          case 'c':
            if (charArr[i+1] === 'h' || charArr[i+1] === 'H') { char = 'ch'; count = 1; }
            break;
